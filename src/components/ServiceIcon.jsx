// Thin line icons drawn to sit inside the frosted ring cards. Deliberately
// uniform in weight and 24x24 box so every card reads as part of one set.
const PATHS = {
  ...
  spark: <><path d="M12 3.5 13.9 9l5.6 1.9-5.6 1.9L12 18.5 10.1 12.8 4.5 10.9 10.1 9z" /><path d="M18.5 16.5 19.3 19l2.2.8-2.2.8-.8 2.2" transform="translate(0 -4)" /></>,
